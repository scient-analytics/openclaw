...
export const DEFAULT_COLLECTIONS = {
  organization: {
    name: "Organization",
    description: "Company info, team members, org decisions",
    icon: "\u{1F3E2}",
  },
  okrs: { name: "OKRs", description: "Objectives and key results", icon: "\u{1F3AF}" },
  brain: { name: "Brain", description: "Agent learnings, knowledge gaps, question queues", icon: "\u{1F9E0}" },
  projects: { name: "Projects", description: "Active projects, backlog", icon: "\u{1F4CB}" },
  workstreams: { name: "Workstreams", description: "Per-person activity logs", icon: "\u{1F4CA}" },
